...
from model.msdn.vgg16 import vgg16
from model.msdn.resnet import resnet
...
if __name__ == '__main__':
  ...
  args.cfg_file = "cfgs/{}_msdn.yml".format(args.net)
  ...
  if not args.resume:
    ...
    load_name = os.path.join(output_dir, 'msdn_{}_a{}_r{}_{}_{}_{}.pth'.format(args.dataset,
  ...
  for epoch in range(args.start_epoch, args.max_epochs):
    ...
    save_name = os.path.join(output_dir, 'msdn_{}_a{}_r{}_{}_{}_{}.pth'.format(args.dataset,
