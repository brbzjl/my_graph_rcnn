...
from model.isgg.vgg16 import vgg16
from model.isgg.resnet import resnet
...
if __name__ == '__main__':
  ...
  args.cfg_file = "cfgs/{}_isgg.yml".format(args.net)
  ...
  if not args.resume:
    ...
    if args.net == 'vgg16':
  	  graphRCNN = vgg16(imdb._classes, imdb._attributes, imdb._relations, 512)
    ...
    load_name = os.path.join(output_dir, 'isgg_{}_a{}_r{}_{}_{}_{}.pth'.format(args.dataset,
    ...
    # initilize the network here.
    if args.net == 'vgg16':
  	  graphRCNN = vgg16(imdb._classes, imdb._attributes, imdb._relations, 512, args.resume)
    elif args.net == 'res101':
  	  graphRCNN = resnet(imdb._classes, imdb._attributes, imdb._relations, 101, args.resume)
    elif args.net == 'res50':
  	  graphRCNN = resnet(imdb._classes, imdb._attributes, imdb._relations, 50, args.resume)
    elif args.net == 'res152':
  	  graphRCNN = resnet(imdb._classes, imdb._attributes, imdb._relations, 152, args.resume)
  ...
  for epoch in range(args.start_epoch, args.max_epochs):
    ...
    for step in range(int(train_size / args.batch_size)):
      ...
      if cfg.HAS_ATTRIBUTES and cfg.HAS_RELATIONS:
          rois, bbox_pred, obj_cls_prob, att_cls_prob, rel_cls_prob, rpn_loss, rcnn_loss = outs
    ...
    save_name = os.path.join(output_dir, 'isgg_{}_a{}_r{}_{}_{}_{}.pth'.format(args.dataset,
