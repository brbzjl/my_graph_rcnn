...
class _ProposalTargetLayer(nn.Module):
    ...
    def forward(self, all_rois, gt_boxes):
        ...
        labels, labels_att, rois, bbox_targets, bbox_inside_weights = \
            self._sample_rois_pytorch(all_rois, gt_boxes, fg_rois_per_image, rois_per_image)

        bbox_outside_weights = (bbox_inside_weights > 0).float()

        return rois, labels, labels_att, bbox_targets, bbox_inside_weights, bbox_outside_weights
    ...
    def _sample_rois_pytorch(self, all_rois, gt_boxes, fg_rois_per_image, rois_per_image):
        ...
        return labels_batch, labels_att_batch, rois_batch, bbox_targets, bbox_inside_weights
