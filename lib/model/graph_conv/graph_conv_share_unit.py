...
class _GraphConvolutionLayer_Collect(nn.Module):
    ...
    def __init__(self, dim):
        ...
        self.collect_units.append(_Collection_Unit(dim)) # from obj
        self.collect_units.append(_Collection_Unit(dim)) # from att
        self.collect_units.append(_Collection_Unit(dim)) # from rel
